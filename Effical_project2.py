...
st.image("https://raw.github.com/hdahhaoui/effical_image/blob/main/logo_img.png", width=500)
...
st.image("https://raw.github.dev/hdahhaoui/effical_image/blob/main/logo_img.png", width=500)
st.success("Chargement terminé !")
